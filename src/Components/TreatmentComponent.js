...
const urlImage = "https://img.freepik.com/free-vector/gradient-prescription-template_23-2149751883.jpg?w=740&t=st=1686303453~exp=1686304053~hmac=e3eb5967de67dd95fdb52102a1a5454003fab560205eb3e73eb42f53a3d70716";
      ...
      <div className="container">
        ...
        <Form onSubmit={this.handleSubmitadd}>
          ...
          <FormGroup row>
            ...
            <Col md={{ size: 2 }}>
              <Button color="warning">{this.state.treatcount}</Button>
            </Col>
          </FormGroup>
        </Form>
        <br />
